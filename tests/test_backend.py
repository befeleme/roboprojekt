...
def test_start_state():
    ...
    """
    ss = State.get_start_state("tests/maps/test_3.json")
...
def test_robot_walk(input_coordinates, input_direction, distance, output_coordinates):
    ...
    """
    state = State.get_start_state("tests/maps/test_3.json")
...
def test_robot_change_direction(current_direction, towards, new_direction):
    ...
    robot.rotate(towards, State.get_start_state("tests/maps/test_3.json"))
...
def test_robot_on_start_has_the_correct_direction():
    ...
    """
    state = State.get_start_state("tests/maps/test_start_direction.json")
...
def test_card_priorities():
    ...
    """
    state = State.get_start_state("tests/maps/test_effects.json")
...
def test_state_from_dict():
    ...
    """
    state = State.get_start_state("tests/maps/test_3.json")
    data = state.whole_as_dict("tests/maps/test_3.json")
